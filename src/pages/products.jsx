...
//solo queremos mostrar un componente a la vez, primero la lista de productos, le damos click a create para crearlo, pasamos a la pagina con el formulario que nos permite crearlo y, si clikeamos cancel, pasamos de nuevo a la lista de productos. para hacer esto, creamo un nuevo estado dentro de Products(), éste tendra el contenido de la pagina.

//queremos mostrar tanto la lista de productos como el formulario en la funcion Products()
